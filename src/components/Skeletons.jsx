import { ImageBox, BoxLine, BoxLineTitleContainer, LiveCasinoImgSection, FeaturedGameBox } from '../helper/styles'
            ...
            {
                {
                    ...
                    '2' : 
                            <>
                                <FeaturedGameBox>
                                    <Skeleton variant='rectangle' animation='wave' width={260} height={500} />
                                </FeaturedGameBox>
                                <FeaturedGameBox>
                                    <Skeleton variant='rectangle' animation='wave' width={260} height={500} />
                                </FeaturedGameBox>
                            ...
                            <>
                                ...
                                <LiveCasinoImgSection>
                                    <Grid container spacing={2}>
                                        <Grid item xs={3}>
                                            <Skeleton variant='rectangle' animation='wave' width={260} height={120} />
                                        </Grid>
                                        <Grid item xs={3}>
                                            <Skeleton variant='rectangle' animation='wave' width={260} height={120} />
                                        </Grid>
